...
public class Tests
{
    ...
    public int Linq1_Limit_ReturnsCustomersCount(decimal limit) => LinqTask.Linq1(DataSource.Customers, limit).Count();

    [Test]
    public void Linq1_NullSource_ThrowsArgumentNullException() => Assert.That(() => LinqTask.Linq1(null, 42).ToList(), Throws.ArgumentNullException);
    ...
    public void Linq2_CustomersAndSuppliers_2CustomersHaveSuppliers()
    {
        ...
        foreach ((Customer customer, IEnumerable<Supplier> suppliers) in result)
        {
    ...
    [Test]
    public void Linq2_NullCustomer_ThrowsArgumentNullException() => Assert.That(() => LinqTask.Linq2(null, null).ToList(), Throws.ArgumentNullException);

    [Test]
    public void Linq2UsingGroup_CustomersAndSuppliers_2CustomersHaveSuppliers()
    {
        List<(Customer customer, IEnumerable<Supplier> suppliers)> result = [.. LinqTask.Linq2UsingGroup(DataSource.Customers, DataSource.Suppliers)];
    ...
    [Test]
    public void Linq2UsingGroup_NullCustomer_ThrowsArgumentNullException() => Assert.That(() => LinqTask.Linq2UsingGroup(null, null).ToList(), Throws.ArgumentNullException);

    [TestCase(800, ExpectedResult = 2)]
    [TestCase(0, ExpectedResult = 6)]
    [TestCase(-1, ExpectedResult = 6)]
    [TestCase(1, ExpectedResult = 5)]
    public int Linq3_Limit_ReturnsCustomersCount(decimal limit) => LinqTask.Linq3(DataSource.Customers, limit).Count();

    [Test]
    public void Linq3_NullCustomer_ThrowsArgumentNullException() => Assert.That(() => LinqTask.Linq3(null, 42).ToList(), Throws.ArgumentNullException);
    ...
    public void Linq4_Customers_CustomersAndDateOfEntry()
    {
        ...
        foreach ((Customer customer, DateTime dateOfEntry) in result)
        {
    ...
    [Test]
    public void Linq4_NullCustomer_ThrowsArgumentNullException() => Assert.That(() => LinqTask.Linq4(null).ToList(), Throws.ArgumentNullException);
    ...
    [Test]
    public void Linq5_NullCustomer_ThrowsArgumentNullException() => Assert.That(() => LinqTask.Linq5(null).ToList(), Throws.ArgumentNullException);
    ...
    [Test]
    public void Linq6_NullCustomer_ThrowsArgumentNullException() => Assert.That(() => LinqTask.Linq6(null).ToList(), Throws.ArgumentNullException);

    [Test]
    public void Linq7_Customers_Returns5()
    {
        Linq7CategoryGroup[] expectedResult =
        [
        ...
        IEnumerable<Linq7CategoryGroup> result = LinqTask.Linq7(DataSource.Products);

        foreach (Linq7CategoryGroup categoryGroup in result)
        {
            Linq7CategoryGroup expectedCategoryGroup = expectedResult.Single(_ => _.Category == categoryGroup.Category);
            foreach (Linq7UnitsInStockGroup unitInStockGroup in categoryGroup.UnitsInStockGroup)
            {
                Linq7UnitsInStockGroup expectedUnitInStockGroup = expectedCategoryGroup
    ...
    [Test]
    public void Linq7_NullProducts_ThrowsArgumentNullException() => Assert.That(() => LinqTask.Linq7(null).ToList(), Throws.ArgumentNullException);
    ...
    public void Linq8_Products_ReturnsGroupedProducts()
    {
        ...
        IEnumerable<Product> cheapProducts = result.Single(_ => _.category == cheap).products;
        Assert.That(cheapProducts.Count(), Is.EqualTo(1));
        IEnumerable<Product> middleProducts = result.Single(_ => _.category == middle).products;
        Assert.That(middleProducts.Count(), Is.EqualTo(3));
        IEnumerable<Product> expensiveProducts = result.Single(_ => _.category == expensive).products;
    ...
    public void Linq9_Customers_ReturnsGroupedProducts()
    {
        ...
        foreach ((string city, int averageIncome, int averageIntensity) in result)
        {
            (string city, int averageIncome, int averageIntensity) expectedValue = expected.Single(_ => _.city == city);
            Assert.That(expectedValue.averageIncome, Is.EqualTo(averageIncome));
            Assert.That(expectedValue.averageIntensity, Is.EqualTo(averageIntensity));
        }
    }
    ...
    [Test]
    public void Linq10_NullSuppliers_ThrowsArgumentNullException() => Assert.That(() => LinqTask.Linq10(null).ToList(), Throws.ArgumentNullException);
